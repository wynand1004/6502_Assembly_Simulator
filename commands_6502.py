...
if __name__ == "__main__":
	...
	for command in commands:
		for opcode in commands[command]:
			mode = commands[command][opcode]['mode']
			length = commands[command][opcode]["length"]
			cycles = commands[command][opcode]["cycles"]
			print("Command: {}  Mode: {}  Length: {}  Clock Cycles: {}".format(command, mode, length, cycles))
		
		print("")	


	# Create new dictionary with opcodes as the key		
	opcode_length = {}

	for command in commands:
		for opcode in commands[command]:
			opcode_length[opcode] = commands[command][opcode]["length"]

	for opcode in opcode_length:
			print("Opcode: {} Length: {}".format(hex(opcode), opcode_length[opcode]))
